...
(defun non-terminal-p (g symbol)
  (when (assoc symbol (canonical-grammar-sym-alist g) :test #'equal)
    (< (cdr (assoc symbol (canonical-grammar-sym-alist g) :test #'equal)) (canonical-grammar-nt-num g))))
